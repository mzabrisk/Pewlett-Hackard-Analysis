...
-- Create table of eligible retirees
SELECT first_name, last_name
...
-- updating table to include emp_no
...
-- Joining retirement_info and dept_emp tables - shortened names
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
...
-- Joining departments and dept_manager tables - shortened names
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
-- Join retierment_info and dept_emp tables, sorting on current employees (to_date = 9999-01-01)
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
